...
public class UpdateStu extends JFrame {
    ...
    public UpdateStu(String s) {
        ...
        comboBox_4.setModel(new DefaultComboBoxModel(new String[] {"电子信息与工程学院"}));
        ...
        comboBox_3.setModel(new DefaultComboBoxModel(new String[] {"计科1701", "计科1702", "计科1703","计科1704"}));
